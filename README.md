...
* **Evaporator Outlet ($t_2$):** $t_2 = t_0 - \frac{\Delta T_e}{1 - e}$
* **Evaporator Inlet ($t_1$):** $t_1 = t_0 - \frac{\Delta T_e \times e}{1 - e} = t_2 + \Delta T_e$
* **Cold Loop Outlet ($t_3$):** $t_3 = t_0 - \Delta T_e$
* **Container/Room Input ($t_6$):** $t_6 = t_3 + \frac{\Delta T_c + \Delta T_h - e \times \Delta T_{room}}{1 - e}$
* **Electric Heater Inlet ($t_5$):** $t_5 = t_6 - \Delta T_h$
* **Condenser Inlet ($t_4$):** $t_4 = t_6 - \Delta T_h - \Delta T_c$
* **Container Exhaust ($t_7$):** $t_7 = t_6 - \Delta T_{room}$
* **System Final Exhaust ($t_8$):** $t_8 = t_3 + \Delta T_c + \Delta T_h - \Delta T_{room}$
